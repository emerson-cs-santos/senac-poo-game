...
####Diagrama de Classe
![Diagrama de Classe](https://github.com/emerson-cs-santos/senac-poo-game/tree/master/src/images/Diagrama_de_classe.png "Diagrama de Classe")
Existe um atributo adicional que é uma lista do tipo efeitos que cada carta pode ter.

####Diagrama de Sequência
![Diagrama de Sequência](https://github.com/emerson-cs-santos/senac-poo-game/tree/master/src/images/Diagrama_de_sequencia.png "Diagrama de Sequência")
